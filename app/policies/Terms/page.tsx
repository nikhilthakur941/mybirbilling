          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div>
              ...
              <div className="flex flex-wrap items-center gap-2 text-xs">
                ...
                <span className="bg-green-500/80 px-2 py-1 rounded-full">
                  Safety First
                </span>
        ...
        <div className="lg:flex lg:gap-8">
          ...
          <div className="lg:w-1/4">
            <div className="sticky top-24">
              ...
              <div className="mt-4 bg-blue-50 border-l-4 border-blue-500 text-blue-800 p-4 rounded-r-lg text-sm">
                <strong>Important:</strong> Your safety is our top priority.
                Following these guidelines ensures a thrilling and secure
                adventure.
              </div>
            </div>
          </div>
          ...
          <div className="lg:w-3/4 mt-8 lg:mt-0">
            <div className="space-y-6">
              ...
              <div
                id="commitment"
                className="bg-white rounded-lg shadow-md border border-slate-200/80 scroll-mt-24"
              >
                ...
                <div className="p-4 text-slate-600 space-y-4">
                  <p>
                    At MyBirBilling, safety isn&apos;t just a guideline;
                    it&apos;s the foundation of every flight.
                  </p>

                  <div className="bg-blue-50 text-blue-800 p-4 rounded-lg">
                    <strong>Your Pilot is in Command:</strong> Always listen to
                    and follow the instructions of your pilot.
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div className="p-4 text-slate-600 space-y-3">
                  <p>
                    <strong>Certified Pilots:</strong> Licensed and highly
                    experienced.
                  </p>

                  <p>
                    <strong>Certified Equipment:</strong> EN/DHV rated gliders
                    and harnesses.
                  </p>

                  <p>
                    <strong>Rigorous Maintenance:</strong> Mandatory safety
                    checks.
                  </p>

                  <p>
                    <strong>Safety Gear:</strong> Helmet and secure harness
                    provided.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div className="p-4 text-slate-600 space-y-3">
                  <p>
                    <strong>Weight Limit:</strong> 25 kg to 90 kg
                  </p>

                  <p>
                    <strong>Physical Fitness:</strong> Able to run a few steps
                  </p>

                  <p>
                    <strong>High Altitude:</strong> Inform us of respiratory
                    issues
                  </p>

                  <p>
                    <strong>Medical Conditions:</strong> Consult doctor if
                    needed
                  </p>
                </div>
              </div>
                ...
                <div className="p-4 text-slate-600 space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="border rounded-lg p-3">
                      ...
                      <a
                        href="mailto:chamelthakur280@gmail.com"
                  ...
                  <div className="mt-4 bg-green-50 text-green-800 p-4 rounded-lg">
                    <strong>Remember:</strong> Your safety is our shared
                    responsibility.
                  </div>
                </div>
              </div>
